# Микро-фреймворк для PHP Joke

Это микро-фреймворк с ручной маршрутизацией и DI-контейнером, ориентированный на обучение. Он обрабатывает HTTP-запросы,
вызывает контроллеры через контейнер и возвращает ответы, но не предоставляет ORM, миграции или готовые компоненты
аутентификации
